...
var URL = "https://yts.mx/api/v2/";
var LIST_MOVIES_URL = URL + "list_movies.json?";
var MOVIE_DETAILS_URL = URL + "movie_details.json";
var MOVIE_SUGGESTION_URL = URL + "movie_suggestion.json";
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        _context3.next = 2;
                        return (0, _axios2.default)(MOVIE_SUGGESTION_URL, {
                            params: {
                                movie_id: id
                            }
                        });
